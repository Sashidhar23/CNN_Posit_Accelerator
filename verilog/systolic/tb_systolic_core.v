...
module tb_systolic_core;
    ...
    task run_until_buffered_one;
        ...
        begin
            ...
            $display("------------------------------------------");
            $display("Output FIFO group produces synchronized column psums");
            if (!seen) begin
    ...
    initial begin
        ...
        $display("==========================================");
        $display("        WS SYSTOLIC CORE TESTBENCH");
        $display("==========================================");
        ...
        check_col_vector(column_psum_out, POSIT_ZERO, "Reset clears column psums");
