...
// Standalone quire-specialized reduced VGG16 MNIST wrapper.
// Generated from reduced_vgg16_mnist.v with conv2D_quire engines.
...
module reduced_vgg16_mnist_quire #(
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(IN_CH), .IN_H(H1), .IN_W(W1), .OUT_CH(C1), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L0 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C1), .IN_H(H1), .IN_W(W1), .OUT_CH(C1), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L1 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C1), .IN_H(H2), .IN_W(W2), .OUT_CH(C2), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L2 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C2), .IN_H(H2), .IN_W(W2), .OUT_CH(C2), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L3 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C2), .IN_H(H3), .IN_W(W3), .OUT_CH(C3), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L4 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C3), .IN_H(H3), .IN_W(W3), .OUT_CH(C3), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L5 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C3), .IN_H(H3), .IN_W(W3), .OUT_CH(C3), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L6 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C3), .IN_H(H4), .IN_W(W4), .OUT_CH(C4), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L7 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C4), .IN_H(H4), .IN_W(W4), .OUT_CH(C4), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L8 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C4), .IN_H(H4), .IN_W(W4), .OUT_CH(C4), .K(3), .PADDING(1), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L9 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(C4), .IN_H(H5), .IN_W(W5), .OUT_CH(FC1), .K(1), .PADDING(0), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L10 (
    ...
    conv2D_quire #(.N(N), .ES(ES), .IN_CH(FC1), .IN_H(1), .IN_W(1), .OUT_CH(NUM_CLASSES), .K(1), .PADDING(0), .STRIDE(1), .ROWS(ROWS), .COLS(COLS)) L11 (
